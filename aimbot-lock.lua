...
local VirtualInputManager = game:GetService("VirtualInputManager") -- Dùng để giả lập thao tác chạm/bắn tự động
    ...
    RunService:BindToRenderStep(BIND_NAME, Enum.RenderPriority.Camera.Value + 1, function()
        ...
        if currentTarget and currentTarget.Character and currentTarget.Character:FindFirstChild(TARGET_PART) then
            ...
            if not onScreen or distanceToCenter > FOV_RADIUS then
                ...
                -- Ép góc quay nhìn thẳng mục tiêu (First Person Fix)
                Camera.CFrame = CFrame.lookAt(Camera.CFrame.Position, targetPart.Position)
                
                -- TỰ ĐỘNG BẮN (AUTO-SHOOT): Kích hoạt chuột ảo click liên tục khi đã khóa cứng mục tiêu
...
UnlinkButton.BackgroundColor3 = Color3.fromRGB(230, 125, 0) -- Màu cam cảnh báo
...
-- Sự kiện click nút Toggle ON/OFF
...
-- Sự kiện nút UNLINK: Hủy mục tiêu lập tức khi có vấn đề (Ví dụ: Đổi ý, lỗi góc khuất kẹt...)
